...
class Forum extends Page {
	...
	function getNumTopics() {
		return DB::query(sprintf('SELECT COUNT(Thread.ID) FROM (SELECT Post.ID FROM Post LEFT JOIN Member ON Post.AuthorID = Member.ID WHERE Post.ForumID = %s AND Member.ForumStatus = \'Normal\' GROUP BY ThreadID) as Thread', $this->ID))->value();
	...
	function getNumPosts() {
		return DB::query(sprintf('SELECT COUNT(Post.ID) FROM Post LEFT JOIN Member ON Post.AuthorID = Member.ID WHERE Post.ForumID = %s AND Member.ForumStatus = \'Normal\'', $this->ID))->value();
	}
