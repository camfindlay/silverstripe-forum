...
class ForumHolder extends Page {
	...
	public function getNumPosts() {
		return DB::query('SELECT COUNT(Post.ID) FROM Post LEFT JOIN Member ON Post.AuthorID = Member.ID WHERE Member.ForumStatus = \'Normal\'')->value();
	}
	...
	function getNumTopics() {
		return DB::query('SELECT COUNT(Thread.ID) FROM (SELECT Post.ID FROM Post LEFT JOIN Member ON Post.AuthorID = Member.ID WHERE Member.ForumStatus = \'Normal\' GROUP BY ThreadID) as Thread')->value();
	}
	...
	public function getNumAuthors() {
		return DB::query('SELECT COUNT(Author.ID) FROM (SELECT Post.ID FROM Post LEFT JOIN Member ON Post.AuthorID = Member.ID WHERE Member.ForumStatus = \'Normal\' GROUP BY AuthorID) as Author')->value();
	}
